...
def load_geo():
    ...
    with open('stores/data/continent_map.txt', 'r') as f:
        continent_map = json.load(f)
    with open('stores/data/country_map.txt', 'r') as f:
        country_map = json.load(f)
    with open('stores/data/province_map.txt', 'r') as f:
        province_map = json.load(f)
    with open('stores/data/city_map.txt', 'r') as f:
